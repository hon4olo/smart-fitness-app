...
- complete the on-device smoke checks for local-data preservation, all primary tabs, Settings, Coach history safe failure, Nutrition library, active workout, force-close recovery, and standalone runtime stability;
