...
describe('nutrition diary and meal-aware add flow 4.0', () => {
  test('main nutrition tab is diary-first and does not keep the old add-food surface', () => {
  ...
  test('main nutrition tab shows exactly one add button per visible meal', () => {
    const source = readSource('src/app/(tabs)/nutrition.tsx');
