...
export type RecoveryScaleValue = 1 | 2 | 3 | 4 | 5;
export type RecoveryZeroToFiveValue = 0 | 1 | 2 | 3 | 4 | 5;

export type RecoveryCheckIn = {
  id: string;
  recordedAt: string;
  sleepDurationHours: number | null;
  sleepQuality: RecoveryScaleValue | null;
  fatigue: RecoveryScaleValue | null;
  soreness: RecoveryZeroToFiveValue | null;
  stress: RecoveryScaleValue | null;
  painInterference: RecoveryZeroToFiveValue | null;
  readiness: RecoveryScaleValue | null;
  notes?: string;
  createdAt: string;
  updatedAt: string;
};
