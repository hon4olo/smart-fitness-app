...
const en = {
  ...
  processingBody: 'Your current approved photo remains public while checks continue.',
  reviewTitle: 'Manual review required',
  reviewBody: 'The new photo remains private. Your current approved photo is unchanged.',
  rejectedTitle: 'Photo was not approved',
  rejectedBody: 'The new image remains private. Choose a different photo or remove this draft.',
  failedTitle: 'Photo processing failed',
  failedBody: 'Your current approved photo is unchanged. Retry with a new upload.',
  deletedTitle: 'Photo removed',
  deletedBody: 'The managed image is no longer attached to your profile.',
  preserveCurrent: 'Your existing approved photo stays public until the replacement is approved.',
  permissionDenied: 'Allow photo-library access in system settings and try again.',
  ...
  tooLarge: 'The prepared photo is still larger than 8 MB. Choose a smaller image.',
  uploadExpired: 'The private upload expired. Choose the photo again.',
  uploadUnavailable: 'Managed photo uploads are not available in this environment yet.',
...
const ru: SocialManagedAvatarCopy = {
  ...
  uploadPendingBody: 'Выберите фото ещё раз, чтобы начать приватную загрузку заново.',
  ...
  processingBody: 'Текущее одобренное фото остаётся публичным во время проверки.',
  reviewTitle: 'Нужна ручная проверка',
  reviewBody: 'Новое фото остаётся приватным. Текущее одобренное фото не изменено.',
  rejectedTitle: 'Фото не одобрено',
  rejectedBody: 'Новое изображение остаётся приватным. Выберите другое фото или удалите черновик.',
  failedTitle: 'Не удалось обработать фото',
  failedBody: 'Текущее одобренное фото не изменено. Повторите загрузку с другим изображением.',
  deletedTitle: 'Фото удалено',
  deletedBody: 'Управляемое изображение больше не привязано к профилю.',
  preserveCurrent: 'Текущее одобренное фото останется публичным до одобрения замены.',
  permissionDenied: 'Разрешите доступ к медиатеке в настройках системы и повторите попытку.',
  ...
  tooLarge: 'После подготовки фото всё ещё больше 8 МБ. Выберите изображение меньшего размера.',
