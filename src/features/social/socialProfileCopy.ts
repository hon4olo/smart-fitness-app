...
const en = {
  ...
  loadError:
    "The social profile could not be loaded. Your private app data was not affected.",
  retry: "Retry",
  username: "Username",
  usernamePlaceholder: "coach_ivan",
  usernameHelp:
    "3–30 letters, numbers, or underscores. Usernames are stored in lowercase.",
...
const ru: SocialProfileCopy = {
  ...
  signInBody:
    "Войдите в аккаунт, чтобы создать или изменить социальный профиль.",
  signInAction: "Войти",
  loading: "Загрузка социального профиля…",
  loadError:
    "Не удалось загрузить социальный профиль. Личные данные приложения не затронуты.",
  retry: "Повторить",
  username: "Имя пользователя",
  usernamePlaceholder: "coach_ivan",
  usernameHelp:
    "От 3 до 30 букв, цифр или символов подчёркивания. Имя хранится в нижнем регистре.",
  ...
  validationUsernameFormat:
    "Используйте от 3 до 30 букв, цифр или символов подчёркивания.",
  validationDisplayNameRequired: "Введите отображаемое имя.",
  validationDisplayNameLength:
    "Отображаемое имя должно содержать не более 80 символов.",
  ...
  errorGeneric:
    "Сейчас не удалось сохранить социальный профиль. Повторите попытку.",
};

export const getSocialProfileCopy = (
  locale: SupportedLocale,
): SocialProfileCopy => (locale === "ru" ? ru : en);
