    ...
    <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={[styles.content, { paddingBottom: safeAreaInsets.bottom + 120 }]} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} style={styles.screen}>
      <View style={styles.container}>
        ...
        <AppCard>
          ...
          <AddBodyMeasurementCard isDisabled={isMeasurementDisabled} measurementLabel={measurementLabel} measurementValue={measurementValue} onChangeLabel={setMeasurementLabel} onChangeValue={setMeasurementValue} onSave={saveMeasurement} />
        </AppCard>
